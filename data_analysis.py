...
if __name__ == "__main__":
    ...
    tree = tree_grow(x_train, x_test, nmin=15, minleaf=41, nfeat=41)
    tree_bagged = tree_grow_b(x_train, x_test, nmin=15, minleaf=41, nfeat=41, m=100)
    random_forest = tree_grow_b(x_train, x_test, nmin=15, minleaf=6, nfeat=6, m=100) # set nfeat to 6 for analysis
